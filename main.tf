...
resource "aws_s3_object" "index_html" {
  ...
  key          = "index.html"
  source       = "/Users/mohamedelzeini/Documents/AI Program - IU/Courses/4.Fourth Term/Cloud Programming/Webpage Project/index.html"
...
resource "aws_s3_object" "imgs" {
  for_each = fileset("/Users/mohamedelzeini/Documents/AI Program - IU/Courses/4.Fourth Term/Cloud Programming/Webpage Project/imgs", "**")
  bucket   = aws_s3_bucket.restaurant_menu_webpage.bucket
  key      = "imgs/${each.value}"
  source   = "/Users/mohamedelzeini/Documents/AI Program - IU/Courses/4.Fourth Term/Cloud Programming/Webpage Project/imgs/${each.value}"
}
